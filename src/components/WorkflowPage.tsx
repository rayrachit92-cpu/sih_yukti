    ...
    <section className="workflow-entry-grid">
      <div className={`workflow-entry ${mode === 'existing' ? 'active' : ''}`}>
        ...
        <div className="workflow-form">
          ...
          <AnimatedButton className="primary-flow" onClick={() => chosen && onGenerate(chosen)} disabled={!chosen}>Generate 3D ULPIN <span>→</span></AnimatedButton>
        </div>
      </div>
      ...
      <div className={`workflow-entry new-entry ${mode === 'new' ? 'active' : ''}`}>
        ...
        <div className="workflow-form">
          ...
          <AnimatedButton className="primary-flow blue-btn" onClick={() => onAddPolygon(newName, coords)}>Validate & Create 3D ULPIN <span>→</span></AnimatedButton>
